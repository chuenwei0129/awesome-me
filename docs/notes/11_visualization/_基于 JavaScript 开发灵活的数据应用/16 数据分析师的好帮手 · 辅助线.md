...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/26/166ae5b6d639c844~tplv-t2oaga2asx-image.image)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/26/166ae5cdef22deb9~tplv-t2oaga2asx-image.image)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/26/166ae5d4b84c7618~tplv-t2oaga2asx-image.image)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/26/166ae5eaf624325f~tplv-t2oaga2asx-image.image)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/26/166ae6040e8e262f~tplv-t2oaga2asx-image.image)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/26/166ae5fa40ead45b~tplv-t2oaga2asx-image.image)

### 16.3.3 计算 SPC 控制图的必要数值

SPC 控制图所使用的数据主要需要计算数据的平均值和标准差（Standard deviation，并非标准误 Standard error）。平均值的计算我们使用 Lodash 中的 `_.mean` 即可，但 Lodash 并没有提供标准差 $\sigma$ 的计算方法，所以我们这里也需要自行实现一下标准差的计算方法。$N$ 为数组 $x$ 的长度，$\overline{x}$ 为数组 $x$ 的平均值。
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/26/166ae602a9bf03e7~tplv-t2oaga2asx-image.image)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/26/166ae608250a756d~tplv-t2oaga2asx-image.image)
