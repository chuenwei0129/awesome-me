...
![ECharts 简单散点图示例](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/7/21/164bb2ce33f4535f~tplv-t2oaga2asx-image.image)
...
![身高图表 - 1](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/7/21/164bbb10d771b392~tplv-t2oaga2asx-image.image)
...
![身高图表 - 2](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/7/21/164bbb10d7680342~tplv-t2oaga2asx-image.image)
...
![身高图表 - 3](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/7/21/164bbb10d7986aaa~tplv-t2oaga2asx-image.image)
...
![身高图表 - 4](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/7/21/164bbb10d784e7f9~tplv-t2oaga2asx-image.image)
...
假设我们限定每一个单位时间内，当前值较前一个值的变化率绝对值不会超过 $r \quad (0 < r < 1)$。

?
\left| \frac{T_{i} - T_{i-1}}{T_{i-1}}\right| < r
?

那么我们便可以使用 JavaScript 中用于生成均匀分布在开区间 $(0, 1)$（不包含 0 与 1）随机数的 `Math.random()` 生成需要的随机数 $rand$，然后通过以下公式得到一个均匀分布在区间 $(-r, r)$ 的随机系数。

?
\text{coefficient} = 2r(rand - 0.5)
?

该公式的推演过程如下。

![random-range](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/7/21/164bd31c470076a9~tplv-t2oaga2asx-image.image)
...
?
T_i = T_{i-1}*(1+\text{coefficient}) \quad (i=1,2,\cdots, n)
?
...
![line-chart-1](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/7/21/164bd31c4d3e92ad~tplv-t2oaga2asx-image.image)
...
![line-chart-2](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/7/21/164bd45e519a9f82~tplv-t2oaga2asx-image.image)
