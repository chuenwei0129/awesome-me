...
![datasets](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/6/17/1640ce29a28642cd~tplv-t2oaga2asx-image.image)
...
![sequences](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/6/17/1640ce284452b9e5~tplv-t2oaga2asx-image.image)
...
![uniq-roots](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/6/17/1640ce28443241b2~tplv-t2oaga2asx-image.image)

**节点是否可重复**

节点是否可重复决定了，转换的目标数据结构究竟是树形结构还是一个关系图谱，当多个序列中出现相同的节点时，因为顺序的关系它们并不处于同一个分支中，就会变成多个分支中有着相同的节点。

![duplicate-nodes](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/6/17/1640ce283cd1833c~tplv-t2oaga2asx-image.image)

**序列中是否允许存在回环**

当序列集中允许出现重复节点时，很可能会出现同一个序列中有着重复的节点，从而形成回环。而在树形结构中，一旦出现回环树形结构便会变为更为立体的关系图谱结构。

![loop-tree](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/6/17/1640ce283cb81d7f~tplv-t2oaga2asx-image.image)
...
![leaf-node](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/6/17/1640ce28444aa4cd~tplv-t2oaga2asx-image.image)
...
![seqs-to-trees-uniq](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/6/17/1640ce2868273600~tplv-t2oaga2asx-image.image)
...
![uniq-roots-steps](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/6/17/1640ce288881f902~tplv-t2oaga2asx-image.image)
...
![seqs-to-trees](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/6/17/1640ce28906329d8~tplv-t2oaga2asx-image.image)
...
![seq-to-edges](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/6/17/1640ce288a8e352d~tplv-t2oaga2asx-image.image)

针对上面 `sequences` 这种形式的序列集，我们可以通过遍历序列中除了最后一个节点以外的所有节点，并返回与其下一个元素所组成的元组，以表达树形结构中的父子节点关系。

?
n_i \rightarrow (n_i, n_{i+1})
?
