    ...
    <div className="diagram-wrapper">
      <div className="diagram-canvas">
        ...
        <div className="blueprint-grid">
          ...
          <div className="spec-block">
            ...
            <div className="input-container warning-mode">
            ...
            <div className="dim-lines">
              <span className="measure">W: AUTO</span>
            </div>
          </div>
          ...
          <div className="spec-block">
            ...
            <div className="input-container error-mode">
              <div className="input-wrapper">
                <input
                  type="text"
                  placeholder="Enter"
      ...
      <style>{`
        :root {
          ...
          --c-text-main: #0f172a;
          --c-text-sub: #64748b;
          --c-accent-error: #ef4444; /* Red for Error only */
        ...
        .diagram-canvas {
          ...
          width: 100%;
          max-width: 800px;
          box-shadow: none; /* No shadow as per rules */
          position: relative;
        }
        ...
        /* 1. Warning State */
        /* Design Choice: Use thick black border + tag for 'Warning' to stay monochromatic but distinct */
        ...
        .cursor-indicator {
            ...
            background: var(--c-text-main);
            margin-left: -2px; 
            animation: none; /* Blueprint static style */
        }
        ...
        .input-container.readonly-mode {
           border-style: dashed; /* Blueprint visual language for 'locked' */
        }

        /* 4. Disabled State */
        .input-container.disabled-mode {
          /* Blueprint Hatching Pattern for Disabled */
