...
const StateReducerCounter = (props: StateReducerCounterProps) => {
  // 内部对接收的 props 做了限制
...
StateReducerCounter.Count = Count;
StateReducerCounter.Label = Label;
StateReducerCounter.Increment = Increment;
StateReducerCounter.Decrement = Decrement;

export { DECREMENT, INCREMENT, useCounter, type CounterActionType, type CounterStateType } from './useCounter';

export { StateReducerCounter };
