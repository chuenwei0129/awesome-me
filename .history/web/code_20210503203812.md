...
- change-case：就是给单词(命名)换成不同的风格，写 Redux 时很有用。
...
- [bracket-pair-colorizer-2](https://marketplace.visualstudio.com/items?itemName=CoenraadS.bracket-pair-colorizer-2)：彩虹
