...
console.log('run', _it.next()) // 第一次执行遇到 yield 停止 // gen
console.log('run', _it.next('yield-1')) // '1' 执行，next传参数是
console.log('run', _it.next('yield-2')) // '2'
console.log('run', _it.next('yield-3')) // '3'
console.log('run', _it.next('yield-4')) // '4' 直到结束 返回 'ret'
